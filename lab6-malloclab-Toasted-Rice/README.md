...
of *trace files* that are included in the distribution. Each trace file contains a sequence of allocate,
...
allocator by computing a *performance index*, <img src="https://render.githubusercontent.com/render/math?math=P">, which is a
weighted sum of the space utilization and throughput
<img src="https://render.githubusercontent.com/render/math?math=P = w{U} %2B (1-w) \min\left(1, \frac{T}{T_{libc}}\right)">
where <img src="https://render.githubusercontent.com/render/math?math=U"> is your space utilization, <img src="https://render.githubusercontent.com/render/math?math=T"> is your throughput, and
<img src="https://render.githubusercontent.com/render/math?math=T_{libc}"> is the estimated throughput of `libc` malloc on your
system on the default traces. The value for <img src="https://render.githubusercontent.com/render/math?math=T_{libc}"> is a
...
default of <img src="https://render.githubusercontent.com/render/math?math=w = 0.6">.
...
metric will contribute at most <img src="https://render.githubusercontent.com/render/math?math=w"> and <img src="https://render.githubusercontent.com/render/math?math=1-w"> to the performance index,
...
needed to automatically build your program. 
This lab assignment is optional. The score of Malloc will be excluded from your final grade.
